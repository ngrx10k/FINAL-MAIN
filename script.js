...
async function fetchGitHubStats(username) {
    try {
        ...
        if (data.public_repos) {
            ...
            const repoCount = document.querySelector('.stat-item:nth-child(1) .stat-number');
            if (repoCount) {
        ...
        if (data.followers) {
            // You could add more GitHub stats here
            console.log(`GitHub followers: ${data.followers}`);
        }
    } catch (error) {
        console.log('GitHub API not available or user not found');
    }
}

// Uncomment and replace 'yourusername' with actual GitHub username to enable GitHub stats
